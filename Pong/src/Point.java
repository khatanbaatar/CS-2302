...
/**
 * The Point Class:
 * Implements a point object where the x and y coordinates can be either
 * integers or doubles.  The integer values are what are returned by
 * getX() and getY() while the doubles are returned by getDblX() and
 * getDblY().
 * 
 * @author Alan Shaw
 */
public class Point
{
     ...
     * 
     * @param xVal is the X coordinate
     * @param xVal is the Y coordinate
     * @return returns the distance to the X and Y coordinate
     */
    public double distance(int xVal, int yVal)
    {
        return Math.sqrt(Math.pow(xVal-this.xPos,2) + Math.pow(yVal-this.yPos,2));
    }
    
    /** 
     * Gets the distance to the X and Y coordinate as doubles
     * 
     * @param xVal is the X coordinate as a double
     * @param xVal is the Y coordinate as a double
     * @return returns the distance to the X and Y coordinate
     */
     ...
     * 
     * @param thePoint is the point from which to determine the distance
