...
/**
 * The Ball Class Implements a ball object that has a position point, a vector
 * determining the x and y components of its motion, a radius, and a color
 * 
 * @author Alan Shaw
 */
...
public class Ball {
	...
	/**
	 * Constructor without parameters set the position and movement vector to
	 * (0,0) and the radius to 0 and the color to black
	 */
	public Ball() {
	 ...
	 * @param xVInit
	 *            is the ball's initial x vector component
	 * @param yVInit
	 *            is the ball's initial y vector component
	 * @param rInit
	 *            is the ball's initial radius
	 * @param rCol
	 *            is the ball's initial color's r component
	 * @param gCol
	 *            is the ball's initial color's g component
	 * @param bCol
	 *            is the ball's initial color's b component
	 */
	public Ball(int xInit, int yInit, int xVInit, int yVInit, int rInit,
			int rCol, int gCol, int bCol) {
	...
	/**
	 * Constructor with double positioning parameters and integer color
	 * parameters
	 * 
	 * @param xInit
	 ...
	 * @param xVInit
	 *            is the ball's initial x vector component as a double
	 * @param yVInit
	 *            is the ball's initial y vector component as a double
	 * @param rInit
	 *            is the ball's initial radius as a double
	 * @param rCol
	 *            is the ball's initial color's r component
	 * @param gCol
	 *            is the ball's initial color's g component
	 ...
	 * 
	 * @param xVal
	 *            is the new X vector component as a double
	 */
	 ...
	 * 
	 * @param yVal
	 *            is the new Y vector component as a double
	 */
	 ...
	 * 
	 * @param xOff
	 *            is the offset for the X coordinate as a double
	 * @param yOff
	 *            is the offset for the Y coordinate as a double
	 */
	 ...
	 * 
	 * @param xVal
	 *            is the new X vector components
	 * @param yVal
	 *            is the new Y vector components
	 */
	 ...
	 * 
	 * @param xVal
	 *            is the new X vector components as a double
	 * @param yVal
	 *            is the new Y vector components as a double
	 */
	 ...
	 * 
	 * @param rCol
	 *            is the new color's Red component
	 * @param gCol
	 *            is the new color's Green component
	 * @param bCol
	 *            is the new color's Blue component
	 */
	 ...
	 * 
	 * @param xVal
	 *            is X coordinate as an integer
	 * @param yVal
	 *            is Y coordinate as an integer
	 ...
	 * 
	 * @param xVal
	 *            is X coordinate as a double
	 * @param yVal
	 *            is Y coordinate as a double
	 * @return Returns the distance to the X and Y coordinate
	 */
	 ...
	 * 
	 * @param pict
	 *            is the Picture object to draw the ball in
	 */
	public void drawBall(Picture pict) {
		Graphics g = pict.getGraphics();

		g.setColor(this.color);
		g.fillOval(this.position.getX() - (int) this.radius, this.position
				.getY()
				- (int) this.radius, (int) (2 * this.radius),
				(int) (2 * this.radius));
	}
	 ...
	 * 
	 * @param pict
	 *            is the Picture object to draw the ball outline in
	 */
	public void drawBallOutline(Picture pict) {
		Graphics g = pict.getGraphics();

		g.setColor(this.color);
		g.drawOval(this.position.getX() - (int) this.radius, this.position
				.getY()
				- (int) this.radius, (int) (2 * this.radius),
				(int) (2 * this.radius));
	}
	 ...
	 * 
	 * @return Returns the Ball's position, it's movement vector, it's radius
	 *         and it's color
	 */
