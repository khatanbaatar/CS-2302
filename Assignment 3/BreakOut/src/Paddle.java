...
public class Paddle extends Rectangle
{
     ...
     */
    public void moveUp(Picture pict)
    {
     ...
     */
    public void moveUp(Picture pict, Ball ball)
    {
        this.y -= this.offset;       // Move y up by the offset
     ...
     * @param pict is the Picture object with the boundary to keep the paddle within
     */
    public void moveDown(Picture pict)
    {
     ...
     * @param ball is a ball that causes the paddle to move back if it's in the way
     */
    public void moveDown(Picture pict, Ball ball)
    {
        this.y += this.offset;       // Move y down by the offset
     ...
     * @param pict is the Picture object with the boundary to keep the paddle within
     */
    public void moveLeft(Picture pict)
    {
     ...
     * @param ball is a ball that causes the paddle to move back if it's in the way
     */
    public void moveLeft(Picture pict, Ball ball)
    {
        this.x -= this.offset;       // Move x left by the offset
     ...
     * @param pict is the Picture object with the boundary to keep the paddle within
     */
    public void moveRight(Picture pict)
    {
     ...
     * @param ball is a ball that causes the paddle to move back if it's in the way
     */
    public void moveRight(Picture pict, Ball ball)
    {
        this.x += this.offset;       // Move x right by the offset
     ...
     */
    public void drawPaddle(Picture pict)
    {
     ...
     */
    public void drawPaddleOutline(Picture pict)
    {
        Graphics g = pict.getGraphics();
     ...
     * @param pict is Picture object to draw the paddle outline in
     */
    public void drawPaddleXtr(Picture pict)
    {
        Graphics g = pict.getGraphics();
